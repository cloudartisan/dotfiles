...
# Claude Code CLI is automatically installed via .chezmoiscripts/run_once_install-claude-code.sh.tmpl
# (uses official installer: curl -fsSL https://claude.ai/install.sh | sh, supports auto-updates)
